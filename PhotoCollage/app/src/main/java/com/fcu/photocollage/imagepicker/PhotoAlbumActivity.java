...
import com.fcu.photocollage.collage.Main;

import java.io.File;
import java.util.ArrayList;
import java.util.HashSet;

import static com.fcu.photocollage.imagepicker.Utility.isImage;
                ...
                while (true) {
                    ...
                    try{
		                if(parentFile != null){
		                	...
		                	//不掃描路徑含.且層級大於5的資料夾
		                	if(parentPath != null && !parentPath.contains(".") && Utility.countMatches(parentPath, File.separator) <= 5){
		                    	//不掃瞄重複路徑
